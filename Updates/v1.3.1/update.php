		...
		<div class="container-inner">
			...
			<?php if ($update == true && $update_stat == false): ?>
				...
				<div class="updates-list">
                    ...
                    <p class="bug">- [Suspend] Temporarily suspended RTL support</p>
                    <p class="bug">- [Fixed] bug with storing the selected language</p>
                    <p class="bug">- [Fixed] bug with the generation of extra sitemaps</p>
                    <p class="bug">- [Fixed] bug with a negative number of followers</p>
				</div>
